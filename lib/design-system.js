// Modern Design System - Color Palette, Typography, Spacing, etc.
...
// Helper function to convert design system values to CSS
...
export function getShadow(size) {
  return designSystem.shadows[size] || 'none';
}
