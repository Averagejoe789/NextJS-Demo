...
export function getCurrentUser() {
  // TEMPORARY: Bypass auth - return mock user with default restaurant ID
  return { uid: DEFAULT_RESTAURANT_ID, email: 'demo@pizzapalace.com' };
 ...
 * Defaults to sample restaurant for demo purposes
 */
export function getRestaurantId() {
  const user = getCurrentUser();
  // Use user's UID as restaurant ID, or default to sample restaurant
